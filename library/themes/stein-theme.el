...
(let*
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face ((t (:foreground ,stein-purple))))
   ...
   ;; mini-modeline
   `(mini-modeline-mode-line ((t (:background ,stein-blue :height 0.1 :box nil))))
   `(mini-modeline-mode-line-inactive ((t (:background ,bg3 :height 0.1 :box nil))))
   ;; mode-line
   ...
   `(org-level-1 ((t (:inherit bold :foreground ,stein-magenta ))))
   `(org-level-2 ((t (:inherit bold :foreground ,stein-purple ))))
   `(org-level-3 ((t (:weight normal :foreground ,stein-green ))))
   `(org-level-4 ((t (:weight normal :foreground ,stein-yellow))))
   `(org-level-5 ((t (:weight normal :foreground ,stein-cyan))))
   `(org-level-6 ((t (:weight normal :foreground ,stein-blue))))
   `(org-level-7 ((t (:weight normal :foreground ,stein-orange))))
   `(org-level-8 ((t (:weight normal :foreground ,stein-fg))))
