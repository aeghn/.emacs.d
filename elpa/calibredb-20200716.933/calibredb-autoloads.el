...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "calibredb-library" '("calibredb-library-")))
...
;;; Generated autoloads from calibredb-transient.el
 (autoload 'calibredb-dispatch "calibredb-dispatch" nil t)
...
(autoload 'calibredb "calibredb-utils" "\
